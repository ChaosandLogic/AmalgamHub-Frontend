import { DAY_COLUMN_WIDTH } from '../../lib/constants/gantt'
...
export default function GanttTimelineHeader({ monthStart, totalDays }: GanttTimelineHeaderProps) {
  const MONTH_HEADER_HEIGHT = 36
  const WEEK_HEADER_HEIGHT = 30
  const DAY_HEADER_HEIGHT = 37
